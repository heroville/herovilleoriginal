...
function sendGa(category: string, label?: string) {
...
export default function OptionsTab() {
  ...
  const handleShowHeroTableChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    game.setHeroTableEnabled?.(e.target.checked);
  };

  const handleSuccessCountChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    game.setSuccessCount?.(Number(e.target.value));
  };

  const handleLossCountChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    game.setLossCount?.(Number(e.target.value));
  };
