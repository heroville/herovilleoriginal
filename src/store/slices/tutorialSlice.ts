...
import type { TutorialState } from '../../types/index.ts';
import { TUTORIAL_LAST_STEP_INDEX } from '../../constants/tutorialSteps.ts';
...
const tutorialSlice = createSlice({
  ...
  reducers: {
    ...
    setTutorialFromSave(
      state,
      action: PayloadAction<{ tutorialStepIndex?: number; tutorialCompleted?: boolean; gameLog?: string[] }>
    ) {
