...
describe('stateToSlices', () => {
  it('maps flat state to sliced shape', () => {
    const flat = { resources: 10, maxResources: 50, gold: 5, heroList: [{ id: 1, name: 'Hero1' }] };
...
describe('selectFullState', () => {
  it('merges sliced state back to flat', () => {
    const sliced = stateToSlices({ resources: 20, gold: 10, heroList: [{ id: 1 }] });
    const flat = selectFullState(sliced);
