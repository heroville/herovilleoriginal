...
function UiServiceFactory() {
    ...
    function nextTutorial(scope) {
        ...
        switch (s.panelNumber) {
            case 0: {
                s.panel = ["You have been granted control of a new town in an unexplored region of the world. Your job is to attract heroes from all over the land to adventure, work and more importantly spend their gold."];
                s.panelNumber++;
                break;
            }
            case 1: {
                s.panel = ["To start off you need to begin by gathering the initial resources so that you can build a Tent to attract your first hero. Click the 'Gather' button until you have enough resources to buy a tent. (5 resources)"];
                s.panelNumber++;
                s.showTutorial = false;
                break;
            }
            case 2: {
                s.panel = ["Alright, now click the 'Improve Tent' button to purchase a tent and unlock your first hero. Your heroes name does not affect their playstyle, feel free to name them whatever you want or just keep the default name."];
                s.panelNumber++;
                break;
            }
            case 3: {
                s.panel = ["Congratulations! You now have your first hero, You can check on your hero by clicking on the newly unlocked 'Hero' tab. This page gives you a quick summary of your heroes. Here you can see their level, health, XP, inventory, location and adventure status. Later you can also see thier profession."];
                s.showTutorial = true;
                s.panelNumber++;
                break;
            }
            case 4: {
                s.panel = ["You may notice that your hero has earnt some gold. If not, they will gain some as they defeat enemies. Unfortunately, your hero is rather reluctant to give you their gold and as a result you need to create items or provide services to encourage them to spend their gold."];
                s.panelNumber++;
                break;
            }
            case 5: {
                s.panel = ["But, before we get to taking gold from the hero we need the room to store it. For this we need to expand the Stockpile, gather the required resources (25) and press the 'Improve Stockpile' button."];
                s.showTutorial = false;
                s.panelNumber++;
                break;
            }
            case 6: {
                s.panel = ["Alright, the stockpile has room for 5 gold and thankfully also unlocks the first item you can produce for a hero, the potion. Once more you will need to gather the required resources (25) head over to the new 'Production' tab and click on the 'Create Potion' button"];
                s.panelNumber++;
                break;
            }
            case 7: {
            ...
            case 8: {
                s.panel = ["You now have your first gold, I would recommend using it to purchase the first upgrade 'Bonus Resources' which will allow you to gain 2 resources per click instead of 1. This upgrade is located in the 'Upgrades' panel and is purchased by clicking on it. Purchase the 'Bonus Resources' upgrade"];
                s.panelNumber++;
                break;
            }
            case 9: {
                s.panel = ["Nice work! Purchasing upgrades costs gold and provide a permenant bonus for the game. It is recommended you keep an eye on the available upgrades"];
                s.showTutorial = true;
                s.panelNumber++;
                break;
            }
            case 10: {
                s.panel = ["By now your hero might be close to level 3 and as such has stopped gaining any experience. To fix this he needs to fight in stronger dungeons, back on the 'Town' tab you can see you have a building called 'Dungeons', once again gather the resources required (25) and click the 'Improve Dungeons' button."];
                s.showTutorial = false;
                s.panelNumber++;
                break;
            }
            case 11: {
                s.panel = ["The new dungeon should be visible on the 'Town' tab, your hero will adventure in this dungeon once he has had enough successes in the previous dungeon. It is important to keep upgrading dungeons so that you are able to keep your heroes earning experience."];
                s.showTutorial = true;
                s.panelNumber++;
                break;
            }
            case 12: {
                s.panel = ["Unfortunately, the stronger dungeons are more of a challenge to adventurers and they will have some trouble completing them without a better weapon. So for that we need a 'Blacksmith', but we cant do that at this time first we need a 'Market'. Gather the required resources (40) and click 'Improve Market'."];
                s.showTutorial = false;
                s.panelNumber++;
                break;
            }
            case 13: {
                s.panel = ["Alright, the market unlocks the ability to purchase blueprints for new buildings allowing you to construct them. Head over to the 'Production' tab and you should see the 'Blacksmith Blueprint' is available for 1 gold. If you havn't already, create another potion for your hero to purchase then click 'Buy Blacksmith Blueprint'. While you wait you can create another tent for a second hero."];
                s.panelNumber++;
                break;
            }
            case 14: {
                s.panel = ["Good Job, you have now unlocked the Blacksmith. Head over to the 'Town' tab and you should now see the Blacksmith listed under buildings. This one is more expensive but certainly worth it. But first, you will need to improve the Stockpile, once you have done that gather the required resources (100) and click 'Improve Blacksmith'."];
                s.panelNumber++;
                break;
            }
            case 15: {
                s.panel = ["The Blacksmith unlocks weapons for your hero to purchase, head over to the 'Production' tab and you should see the 'Dagger' is now available. Gather the required 15 resources and click 'Create Dagger'."];
                s.panelNumber++;
                break;
            }
            case 16: {
